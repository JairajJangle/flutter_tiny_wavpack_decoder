...
- add Swift Package Manager support for iOS and macOS (5fb6ba0)
...
- add web (wasm) support and decodeBytes API (67805a4)
...
- verify end-to-end automated release with GitHub release creation (90fefaf)
